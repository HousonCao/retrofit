...
public final class ObservableTest {
  ...
  @Test public void bodySuccess200() {
    ...
    RecordingSubscriber<String> subscriber = subscriberRule.get();
  ...
  @Test public void bodyRespectsBackpressure() {
    ...
    RecordingSubscriber<String> subscriber = subscriberRule.get(0);
    service.body().unsafeSubscribe(subscriber);
  ...
  @Test public void responseSuccess200() {
    ...
    RecordingSubscriber<Response<String>> subscriber = subscriberRule.get();
  ...
  @Test public void responseRespectsBackpressure() {
    ...
    RecordingSubscriber<Response<String>> subscriber = subscriberRule.get(0);
    service.response().unsafeSubscribe(subscriber);
    assertThat(server.getRequestCount()).isEqualTo(0);
  ...
  @Test public void resultSuccess200() {
    ...
    RecordingSubscriber<Result<String>> subscriber = subscriberRule.get();
  ...
  @Test public void resultRespectsBackpressure() {
    ...
    RecordingSubscriber<Result<String>> subscriber = subscriberRule.get(0);
    service.result().unsafeSubscribe(subscriber);
    assertThat(server.getRequestCount()).isEqualTo(0);
