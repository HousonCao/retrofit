...
/** A test {@link Subscriber} and JUnit which guarantees all events are asserted. */
final class RecordingSubscriber<T> extends Subscriber<T> {
  ...
  public void assertError(Throwable throwable) {
    assertThat(takeError()).isSameAs(throwable);
  }
  ...
  public static final class Rule implements TestRule {
    ...
    public <T> RecordingSubscriber<T> get() {
      return get(Long.MAX_VALUE);
    }

    public <T> RecordingSubscriber<T> get(long initialRequest) {
